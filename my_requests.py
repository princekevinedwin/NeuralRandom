...
def open_main_window():
    ...
    # Widgets
    city_label = tk.Label(main_window, text="Enter city:", font=("Times new roman", 20, "bold"), fg="white", bg="midnightblue", width=10)
    ...
    search_button = tk.Button(main_window, text="Get Weather", command=get_weather, font=("Times new roman", 15), fg="midnightblue", bg="white")
    search_button.pack(pady=10, padx=10)

    header_label = tk.Label(main_window, text="Weather Information ↓ ↓", font=("arial black", 15, "bold"), fg="white", bg="midnightblue", width=36)
    header_label.pack(pady=0, padx=10)

    result_text = tk.StringVar()
    result_label = tk.Label(main_window, textvariable=result_text, font=("arial", 15), anchor="center", justify="left", width=46)
...
cover_image_path = r"C:\Users\user pc\Pictures\853710_weather-wallpapers-free-desktop-backgrounds-wallpapers-path_1920x1200_h.jpg"
...
cover_label = tk.Label(cover_page, text="Welcome to K.H.A.K.E Weather App", font=("impact", 25), fg="midnightblue", bg="white")
cover_label.pack(pady=20)

# Button to open the main window
open_main_button = tk.Button(cover_page, text="OPEN", command=open_main_window, font=("arial black", 15), fg="midnightblue", bg="white")
